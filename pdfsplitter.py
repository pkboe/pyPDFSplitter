...
# Form implementation generated from reading ui file '.\pdfsplitter.ui'
#
...
"font: 8pt \"Segoe Print\";")
    ...
    def splitPDF(self):
        keys =  keys=self.lineEdit.text().split(',')
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "Split by keys (comma separated)"))
